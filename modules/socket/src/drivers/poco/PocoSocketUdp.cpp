...
// see PocoSocketTcp.cpp: receive is a poll loop guarded by an atomic close flag so close() never blocks
// behind an in-flight receiveFrom and never races the socket fd.
