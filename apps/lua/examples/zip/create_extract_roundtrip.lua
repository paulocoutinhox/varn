...
async.spawn(function()
    ...
    local zipPath = "apps/lua/examples/zip/_test_roundtrip.zip"
    local extractDir = "apps/lua/examples/zip/_extract_out"
    local srcPath = "apps/lua/examples/zip/fixture_hello.txt"
