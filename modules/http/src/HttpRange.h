...
class HttpRange {
public:
    // returns false for a malformed, unsatisfiable, or overflowing spec; an end past the
    // file is clamped to the last byte. only the single-range form is handled here.
